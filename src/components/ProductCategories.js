...
const ProductCategories = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-3 gap-12"> {/* Điều chỉnh gap để tăng khoảng cách giữa các phần tử */}
        <div className="text-center">
          <div className="w-full h-80 overflow-hidden mb-4"> {/* Cố định chiều cao và khoảng cách bên dưới */}
            <img 
          ...
          <h3 className="text-2xl font-semibold mb-2">Women</h3> {/* Tăng kích thước chữ và khoảng cách */}
          <p className="text-gray-600 text-lg">Spring 2018</p> {/* Tăng kích thước chữ và màu sắc */}
        </div>
        <div className="text-center">
          <div className="w-full h-80 overflow-hidden mb-4"> {/* Cố định chiều cao và khoảng cách bên dưới */}
            <img 
          ...
          <h3 className="text-2xl font-semibold mb-2">Men</h3> {/* Tăng kích thước chữ và khoảng cách */}
          <p className="text-gray-600 text-lg">Spring 2018</p> {/* Tăng kích thước chữ và màu sắc */}
        </div>
        <div className="text-center">
          <div className="w-full h-80 overflow-hidden mb-4"> {/* Cố định chiều cao và khoảng cách bên dưới */}
          ...
          <h3 className="text-2xl font-semibold mb-2">Accessories</h3> {/* Tăng kích thước chữ và khoảng cách */}
          <p className="text-gray-600 text-lg">New Trend</p> {/* Tăng kích thước chữ và màu sắc */}
        </div>
      </div>
    </div>
  );
