    ...
    <div className="h-screen w-64 bg-white text-gray-800 fixed flex flex-col border-r border-gray-300"> 
      ...
      <div className="overflow-y-auto overflow-x-hidden flex-grow">
        <ul className="flex flex-col py-4 space-y-1">
          ...
          <li>
            <Link to={ROUTES.ORDERS} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
              <span className="inline-flex justify-center items-center ml-4">
                <FaUsers className="w-5 h-5" />
              </span>
              <span className="ml-2 text-sm tracking-wide truncate">Order Management</span>
            </Link>
          </li>
        </ul>
      </div>
